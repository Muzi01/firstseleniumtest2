...
final class PolishTaxOfficeCodesService implements TaxOfficeCodesGenerator {
  ...
  public String generate() {
    final int randomTaxOfficeCode = new Random().nextInt(getTaxArrayLength());
    return CODES[randomTaxOfficeCode];
  }

  private int getTaxArrayLength() {
    return CODES.length;
  }
}
