...
public class DeactivateExtraServiceRequestSchema {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof DeactivateExtraServiceRequestSchema)) {
      return false;
    }
    final DeactivateExtraServiceRequestSchema rhs = ((DeactivateExtraServiceRequestSchema) other);
