...
public class UpdateChequeStatusRequestExample {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof UpdateChequeStatusRequestExample)) {
      return false;
    }
    final UpdateChequeStatusRequestExample rhs = ((UpdateChequeStatusRequestExample) other);
