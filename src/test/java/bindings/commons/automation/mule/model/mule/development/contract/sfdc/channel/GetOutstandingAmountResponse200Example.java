...
public class GetOutstandingAmountResponse200Example {
  ...
  @JsonProperty ("body")
  private BodyGetOutstandingAmountResponse200 body;
  @JsonIgnore
  ...
  @JsonProperty ("body")
  public BodyGetOutstandingAmountResponse200 getBody() {
    return this.body;
  }

  @JsonProperty ("body")
  public void setBody(final BodyGetOutstandingAmountResponse200 body) {
    this.body = body;
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof GetOutstandingAmountResponse200Example)) {
      return false;
    }
    final GetOutstandingAmountResponse200Example rhs =
        ((GetOutstandingAmountResponse200Example) other);
