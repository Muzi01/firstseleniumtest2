...
public class IdentifySpouseResponseExample {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof IdentifySpouseResponseExample)) {
      return false;
    }
    final IdentifySpouseResponseExample rhs = ((IdentifySpouseResponseExample) other);
