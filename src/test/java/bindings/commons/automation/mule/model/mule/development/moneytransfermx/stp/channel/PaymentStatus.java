...
public class PaymentStatus {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(this.id).append(this.status).append(this.detail)
  ...
  public boolean equals(final Object other) {
    ...
    final PaymentStatus rhs = ((PaymentStatus) other);
    return new EqualsBuilder().append(this.id, rhs.id).append(this.status, rhs.status)
        .append(this.detail, rhs.detail).append(this.additionalProperties, rhs.additionalProperties)
        .isEquals();
  }
