...
public class PaymentStatusResponseDefault {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof PaymentStatusResponseDefault)) {
      return false;
    }
    final PaymentStatusResponseDefault rhs = ((PaymentStatusResponseDefault) other);
