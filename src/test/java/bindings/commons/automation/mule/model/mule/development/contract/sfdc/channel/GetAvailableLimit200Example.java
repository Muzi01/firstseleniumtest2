...
public class GetAvailableLimit200Example {
  ...
  @JsonProperty ("body")
  private BodyGetAvailableLimit200 body;
  @JsonIgnore
  ...
  @JsonProperty ("body")
  public BodyGetAvailableLimit200 getBody() {
    return this.body;
  }

  @JsonProperty ("body")
  public void setBody(final BodyGetAvailableLimit200 body) {
    this.body = body;
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof GetAvailableLimit200Example)) {
      return false;
    }
    final GetAvailableLimit200Example rhs = ((GetAvailableLimit200Example) other);
