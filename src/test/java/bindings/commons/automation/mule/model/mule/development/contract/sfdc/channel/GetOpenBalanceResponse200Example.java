...
public class GetOpenBalanceResponse200Example {
  ...
  @JsonProperty ("body")
  private BodyGetOpenBalanceResponse200 body;
  @JsonIgnore
  ...
  @JsonProperty ("body")
  public BodyGetOpenBalanceResponse200 getBody() {
    return this.body;
  }

  @JsonProperty ("body")
  public void setBody(final BodyGetOpenBalanceResponse200 body) {
    this.body = body;
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof GetOpenBalanceResponse200Example)) {
      return false;
    }
    final GetOpenBalanceResponse200Example rhs = ((GetOpenBalanceResponse200Example) other);
