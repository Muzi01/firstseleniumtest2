...
public class ChangeApplicationProductResponse417Example {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof ChangeApplicationProductResponse417Example)) {
      return false;
    }
    final ChangeApplicationProductResponse417Example rhs =
        ((ChangeApplicationProductResponse417Example) other);
