...
public class CreateChequeResponseExample {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof CreateChequeResponseExample)) {
      return false;
    }
    final CreateChequeResponseExample rhs = ((CreateChequeResponseExample) other);
