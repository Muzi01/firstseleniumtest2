...
public class ListInvoiceAllocations200Example {
  ...
  @JsonProperty ("body")
  private List<BodyListInvoiceAllocations200> body = new ArrayList<>();
  @JsonIgnore
  ...
  @JsonProperty ("body")
  public List<BodyListInvoiceAllocations200> getBody() {
    return this.body;
  }

  @JsonProperty ("body")
  public void setBody(final List<BodyListInvoiceAllocations200> body) {
    this.body = body;
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof ListInvoiceAllocations200Example)) {
      return false;
    }
    final ListInvoiceAllocations200Example rhs = ((ListInvoiceAllocations200Example) other);
