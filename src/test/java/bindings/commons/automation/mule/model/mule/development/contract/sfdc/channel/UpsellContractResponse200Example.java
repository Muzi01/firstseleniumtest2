...
public class UpsellContractResponse200Example {
  ...
  @JsonProperty ("body")
  private BodyUpsellContractResponse200 body;
  @JsonIgnore
  ...
  @JsonProperty ("body")
  public BodyUpsellContractResponse200 getBody() {
    return this.body;
  }

  @JsonProperty ("body")
  public void setBody(final BodyUpsellContractResponse200 body) {
    this.body = body;
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof UpsellContractResponse200Example)) {
      return false;
    }
    final UpsellContractResponse200Example rhs = ((UpsellContractResponse200Example) other);
