...
public class RetryTransfersRequestExample {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(this.retryTransfersRequestList).append(
  ...
  public boolean equals(final Object other) {
    ...
    return new EqualsBuilder().append(this.retryTransfersRequestList, rhs.retryTransfersRequestList)
