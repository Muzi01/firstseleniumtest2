...
public class GetOutstandingAmountResponse500Example {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof GetOutstandingAmountResponse500Example)) {
      return false;
    }
    final GetOutstandingAmountResponse500Example rhs =
        ((GetOutstandingAmountResponse500Example) other);
