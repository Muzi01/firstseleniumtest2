...
public class RetryTransfersRequestList {
  ...
  public int hashCode() {
    return new HashCodeBuilder()
        ...
        .append(this.transferStatus)
        .append(this.blueCashTransfer)
  ...
  public boolean equals(final Object other) {
    ...
    return new EqualsBuilder()
        ...
        .append(this.transferAmount, rhs.transferAmount).append(this.currency, rhs.currency)
        .append(this.transferStatus, rhs.transferStatus)
