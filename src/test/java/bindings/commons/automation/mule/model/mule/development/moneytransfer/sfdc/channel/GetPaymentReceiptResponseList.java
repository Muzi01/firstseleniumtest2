...
public class GetPaymentReceiptResponseList {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof GetPaymentReceiptResponseList)) {
      return false;
    }
    final GetPaymentReceiptResponseList rhs = ((GetPaymentReceiptResponseList) other);
