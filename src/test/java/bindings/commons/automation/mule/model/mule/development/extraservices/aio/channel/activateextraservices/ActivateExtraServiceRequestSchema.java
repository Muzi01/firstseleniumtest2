...
public class ActivateExtraServiceRequestSchema {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof ActivateExtraServiceRequestSchema)) {
      return false;
    }
    final ActivateExtraServiceRequestSchema rhs = ((ActivateExtraServiceRequestSchema) other);
