...
public class ChangeApplicationProductResponse424Example {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof ChangeApplicationProductResponse424Example)) {
      return false;
    }
    final ChangeApplicationProductResponse424Example rhs =
        ((ChangeApplicationProductResponse424Example) other);
