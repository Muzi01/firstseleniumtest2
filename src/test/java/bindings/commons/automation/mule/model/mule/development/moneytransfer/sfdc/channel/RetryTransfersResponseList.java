...
public class RetryTransfersResponseList {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(this.success).append(this.resultCode).append(
        this.transferAppId)
        .append(this.transferId).append(this.additionalProperties).toHashCode();
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof RetryTransfersResponseList)) {
      return false;
    }
    final RetryTransfersResponseList rhs = ((RetryTransfersResponseList) other);
    return new EqualsBuilder().append(this.success, rhs.success)
        .append(this.resultCode, rhs.resultCode)
        .append(this.transferAppId, rhs.transferAppId).append(this.transferId, rhs.transferId)
