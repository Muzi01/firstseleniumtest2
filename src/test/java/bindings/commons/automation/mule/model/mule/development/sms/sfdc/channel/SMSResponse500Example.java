...
public class SMSResponse500Example {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(this.success).append(this.reason).append(this.statuses)
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof SMSResponse500Example)) {
      return false;
    }
    final SMSResponse500Example rhs = ((SMSResponse500Example) other);
