...
public class RefetchExternalRegistryResponseExample {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof RefetchExternalRegistryResponseExample)) {
      return false;
    }
    final RefetchExternalRegistryResponseExample rhs =
        ((RefetchExternalRegistryResponseExample) other);
